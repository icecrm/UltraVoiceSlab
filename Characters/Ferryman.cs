...
namespace UltraVoice.Characters
{
    public class FerrymanCharacter
    {
        ...
        public static void PlayRandomVoice(UnityEngine.Component ferryman, AudioClip[] clips, string[] subs, bool interrupt = false, UnityEngine.Color? colorOverride = null)
        {
            ...
            VoiceManager.CreateVoiceSource(ferryman, "Ferryman", clips[i], sub, interrupt, colorOverride);
        }
    ...
    class FerrymanChatterPatch
    {
        static void Postfix(Ferryman __instance)
        {
            ...
            FerrymanCharacter.PlayRandomVoice(
                __instance,
