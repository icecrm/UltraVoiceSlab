...
namespace UltraVoice.Characters
{
    public class GuttermanCharacter
    {
        ...
        public static void PlayRandomVoice(UnityEngine.Component gutterman, AudioClip[] clips, string[] subs, bool interrupt = false, UnityEngine.Color? colorOverride = null)
        {
            ...
            VoiceManager.CreateVoiceSource(gutterman, "Gutterman", clips[i], sub, interrupt, colorOverride);
        }
    }
    ...
    class GuttermanSpawnPatch
    {
        static void Postfix(Gutterman __instance)
        {
            ...
            GuttermanCharacter.PlayRandomVoice(
                __instance,
    ...
    class GuttermanShieldBreakPatch
    {
        static void Postfix(Gutterman __instance)
        {
            ...
            else GuttermanCharacter.PlayRandomVoice(
                __instance,
