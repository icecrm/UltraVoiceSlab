...
namespace UltraVoice.Characters
{
    public class V2Character
    {
        ...
        public static void PlayRandomVoice(UnityEngine.Component v2, AudioClip[] clips, string[] subs, bool interrupt = false, UnityEngine.Color? colorOverride = null)
        {
            ...
            VoiceManager.CreateVoiceSource(v2, "V2", clips[i], sub, interrupt, colorOverride);
        }
    }
