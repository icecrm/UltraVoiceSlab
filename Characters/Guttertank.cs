...
namespace UltraVoice.Characters
{
    public class GuttertankCharacter
    {
        ...
        public static void PlayRandomVoice(UnityEngine.Component guttertank, AudioClip[] clips, string[] subs, bool interrupt = false, UnityEngine.Color? colorOverride = null)
        {
            ...
            VoiceManager.CreateVoiceSource(guttertank, "Guttertank", clips[i], sub, interrupt, colorOverride);
        }
    }
    ...
    class GuttertankSpawnPatch
    {
        static void Postfix(Guttertank __instance)
        {
            ...
            UltraVoicePlugin.Instance.StartCoroutine(UltraVoicePlugin.DelayedVox(() =>
                GuttertankCharacter.PlayRandomVoice(
                    __instance,
